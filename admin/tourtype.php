...
<head>
    <title>ADMIN - QL loại tour</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
                                    ...
                                    <li class="menu-item my-3 p-1">
                                        ...
                                        <div class="collapse" id="tour">
                                            <ul class="flex-column">
                                                <li class="mt-3"><a class="active" href="tourtype.php">Quản lý phân loại tour</a></li>
                    ...
                    <div class="container">
                        ...
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="pt-2">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Quản lý phân loại tour</li>
                            </ol>
                          </nav>
                        <div class="">
                            <div class="page-header text-center pt-2">
                                <h3>Quản lý phân loại tour</small></h3>
                            </div>
                            <div class="add">
                                <button type="button" class="btn btn-primary my-3" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal"><i class="fa-solid fa-user-plus"></i> 
                                    Thêm loại tour</button>
                                <!-- Modal -->
                            ...
                            <div class="panel panel-default">
                                ...
                                <?php 
                                    if(isset($conn)) {
                                        $stmt = $conn->prepare("SELECT t.ttID, t.ttName, (
                                                                            SELECT COUNT(*) 
                                                                            FROM tours
                                                                            WHERE ttID = t.ttID
                                                                        ) AS total_tours
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<tr>";
                                                echo "<td>". $row['ttID'] ."</td>";
                                                echo "<td>". $row['ttName'] ."</td>";
                                                echo "<td>". $row['total_tours'] ."</td>";
                                                echo "</tr>";
                                            }
